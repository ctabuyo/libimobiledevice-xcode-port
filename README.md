# libimobiledevice-xcode-port by CTABUYO

*A library to communicate with services on iOS devices using native protocols.*

Ported to be compiled using XCODE in Mac by CTABUYO

*Make sure to install all required dependencies to build libimobiledevice as stated before FIRST. Otherwise compilation will fail!*
